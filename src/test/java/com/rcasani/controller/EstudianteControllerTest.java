...
public class EstudianteControllerTest {
    ...
    public void findAllTest() throws Exception {
        ...
        mockMvc.perform(MockMvcRequestBuilders
                ...
                .andExpect(jsonPath("$.data[0].nombres", is("Ronal Paul")))
                .andExpect(jsonPath("$.data[1].nombres", is("Katia Andrea")));
    }
    ...
    public void findByIdTest() throws Exception {
        ...
        Mockito.when(estudianteService.buscar(ID)).thenReturn(ESTUDIANTE_1);
